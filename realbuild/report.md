...
|---|---|---|---|
| t_6 | 2 | 10 | ∞ |
| traffic_amber_int | 2 | 8 | ∞ |
| $0\state_STOP[0:0] | 7 | 3 | ∞ |
| hold_s2 | 2 | 7 | ∞ |
| request_s2 | 2 | 7 | ∞ |
| walk_int | 2 | 7 | ∞ |
| $abc$148$new_n21_ | 2 | 6 | ∞ |
| state_STOP | 2 | 6 | ∞ |
| t_0 | 2 | 5 | ∞ |
| traffic_green_int | 2 | 5 | ∞ |

Unobservable nets (no path to any primary output; rendered as an overlay by C12): $0\state_STOP[0:0], $abc$148$new_n13_, $abc$148$new_n14_, $abc$148$new_n17_, $abc$148$new_n19_, $abc$148$new_n21_, $abc$148$new_n22_, $abc$148$new_n23_, hold, hold_s1, hold_s2, next_GO, request, request_s1, request_s2, rst_n_s1, state_STOP, t_0, t_3, t_6, traffic_amber_int, traffic_green_int, traffic_red_int, walk_int
...
- uncollapsed faults (nets + cell pins): 224
- collapsed faults (equivalence + dominance): 67
- detected: 54, undetected: 0, redundant: 7, untestable: 6
